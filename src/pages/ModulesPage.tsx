    ...
    <div className="space-y-6 font-sans">
      ...
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 p-6 rounded-2xl bg-white dark:bg-night-900 border border-gray-200/90 dark:border-night-800 shadow-card transition-colors">
        <div className="flex items-start gap-4">
          <div className="w-14 h-14 rounded-2xl bg-emerald-50 dark:bg-emerald-950/50 border border-emerald-100 dark:border-emerald-800/40 flex items-center justify-center font-bold text-brand-700 dark:text-brand-400 text-lg flex-shrink-0">
        ...
        <div className="flex items-center gap-4">
          <div className="text-xs text-right hidden sm:block">
            <span className="text-brand-700 dark:text-brand-400 font-bold text-sm">{currentCompany.enabledModules.length}</span>
          ...
          <button 
            ...
            className="flex items-center gap-2 px-4 py-2 text-xs font-semibold text-gray-600 dark:text-gray-300 bg-gray-50 dark:bg-night-800 border border-gray-200 dark:border-gray-800 rounded-xl hover:bg-gray-100 dark:hover:bg-gray-800 transition-colors cursor-pointer"
          >
          ...
          <button
            ...
            className={`px-3.5 py-1.5 rounded-xl text-xs font-medium transition-colors cursor-pointer ${
              selectedCategory === cat
                ...
                : 'bg-white dark:bg-night-900 text-gray-600 dark:text-gray-400 border border-gray-200 dark:border-night-800 hover:text-gray-900 dark:hover:text-white shadow-xs'
            }`}
          >
          ...
          return (
            <div
              ...
              className={`p-5 rounded-2xl border transition-all flex flex-col justify-between shadow-card hover:shadow-card-hover ${
                isEnabled
                  ? 'bg-white dark:bg-night-900 border-emerald-300 dark:border-emerald-800/80'
                  : 'bg-white/70 dark:bg-night-950/80 border-gray-200 dark:border-night-800 opacity-90'
              }`}
            >
              <div>
                <div className="flex items-start justify-between gap-2">
                  <div className={`w-10 h-10 rounded-xl flex items-center justify-center ${
                    isEnabled 
                      ? 'bg-emerald-50 dark:bg-emerald-950/50 border border-emerald-100 dark:border-emerald-800/40 text-brand-700 dark:text-brand-400' 
                ...
                <div className="mt-3 flex flex-wrap gap-1">
                  {mod.tags.map(t => (
                    <span 
                      key={t}
                      className="text-micro px-2 py-0.5 rounded-md bg-gray-100 dark:bg-night-800 text-gray-600 dark:text-gray-400 font-mono"
                    >
                      #{t}
                    </span>
                  ))}
              ...
              {/* Card Footer Action */}
              <div className="mt-5 pt-3 border-t border-gray-100 dark:border-night-800 flex items-center justify-between">
