      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
        {filteredReports.map((rep) => (
          ...
          >
            ...
            {/* Formats & Action CTAs */}
            <div className="mt-4 pt-3.5 border-t border-gray-100 dark:border-night-800 flex items-center justify-between">
              ...
              <div className="flex items-center gap-2">
                <button
                  ...
                  className="px-2.5 py-1.5 rounded-lg bg-gray-50 dark:bg-night-850 border border-gray-200 dark:border-night-800 hover:border-emerald-500 dark:hover:border-emerald-500 text-gray-700 dark:text-gray-300 hover:text-brand-700 dark:hover:text-brand-400 dark:hover:text-emerald-400 text-xs font-medium flex items-center gap-1 cursor-pointer"
                ...
                <button
                  ...
                  aria-label="Exportar PDF" title="Exportar PDF"
                >
        ...
        >
          <div className="space-y-4 text-xs font-sans">
                ...
                <table className="w-full text-left text-xs">
                  ...
                  <tbody className="divide-y divide-gray-100 text-gray-700">
                    <tr>
                      ...
                      <td className="p-2.5 font-bold text-brand-700 dark:text-brand-400">1.840 unid.</td>
                      <td className="p-2.5">1.750 unid.</td>
                      <td className="p-2.5 text-right text-brand-700 dark:text-brand-400 font-semibold">+5.1%</td>
                    </tr>
                    <tr>
                      ...
                      <td className="p-2.5 text-right text-brand-700 dark:text-brand-400 font-semibold">+3.4%</td>
                    </tr>
                    <tr>
                      <td className="p-2.5">Índice de Ocorrências</td>
                      <td className="p-2.5 font-bold text-gray-900">1.2%</td>
                      <td className="p-2.5">&lt; 2.0%</td>
                      <td className="p-2.5 text-right text-brand-700 dark:text-brand-400 font-semibold">-0.8%</td>
                    </tr>
                  </tbody>
                </table>
              </div>
            ...
            <div className="flex items-center justify-between pt-3 border-t border-gray-100">
              <span className="text-gray-600 dark:text-gray-400 text-xs">Gerado por CopperOS Engine</span>
